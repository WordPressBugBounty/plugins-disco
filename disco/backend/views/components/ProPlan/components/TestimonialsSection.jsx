...
function TestimonialsSection() {
	return (
		<div className="disco:max-w-5xl disco:mx-auto disco:px-4 disco:py-12">
			...
			<div className="disco:grid disco:grid-cols-1 disco:md:grid-cols-3 disco:gap-6">
				{testimonials.map((t, i) => (
					<div
						key={i}
						className="disco:flex disco:flex-col disco:justify-between disco:bg-white disco:border-2 disco:border-gray-200 disco:rounded-xl disco:p-5 disco:hover:border-primary disco:transition-all"
					>
						<div>
