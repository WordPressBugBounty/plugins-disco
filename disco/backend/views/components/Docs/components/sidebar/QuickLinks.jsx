			...
			<div className="disco:flex disco:flex-col disco:gap-1">
				{quickLinks.map((obj, i) => (
					<a
						...
						className="disco:flex disco:items-center disco:gap-3 disco:py-2.5 disco:px-3 disco:rounded-lg disco:no-underline disco:text-gray-700! disco:hover:text-primary! disco:hover:bg-gray-50 disco:transition-colors disco:cursor-pointer"
					>
