export default function DiscoResourceCard({
	...
	return (
		<a
			...
			className="disco:bg-white disco:rounded-2xl disco:overflow-hidden disco:shadow-sm disco:border-2 disco:border-gray-100 disco:hover:shadow-md disco:cursor-pointer disco:flex disco:flex-col disco:no-underline disco:hover:border-primary disco:hover:-translate-y-1 disco:transition-all!  disco:focus:shadow-none"
		>
