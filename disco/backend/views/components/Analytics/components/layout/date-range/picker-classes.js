const PICKER_CLASSES = {
	...
	button_previous:
		'disco:flex disco:h-8 disco:w-8 disco:items-center disco:justify-center disco:rounded disco:text-[rgba(74,74,74,0.4)] disco:transition-colors disco:hover:text-[rgba(74,74,74,0.8)] disco:disabled:opacity-30 disco:z-10',
	button_next:
		'disco:flex disco:h-8 disco:w-8 disco:items-center disco:justify-center disco:rounded disco:text-[rgba(74,74,74,0.4)] disco:transition-colors disco:hover:text-[rgba(74,74,74,0.8)] disco:disabled:opacity-30 disco:z-10',
	weekdays: 'disco:flex',
