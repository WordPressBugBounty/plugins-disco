...
const ImagePreview = ({
	...
	return (
		<>
			<div className="disco:max-h-[350px] disco:overflow-y-auto disco:rounded-lg disco:bg-white disco:my-4 disco:py-4 disco:px-4 disco:border disco-no-scrollbar">
								...
								>
									{id && (
										<button
											...
											className="disco:absolute disco:top-1 disco:right-1 disco:hidden disco:group-hover:flex disco:items-center disco:justify-center disco:w-5 disco:h-5 disco:rounded-full disco:bg-red-500 disco:cursor-pointer disco:hover:bg-red-600 disco:z-10"
										>
