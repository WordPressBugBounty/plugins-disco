			...
			<div className="disco:flex disco:flex-col disco:gap-2">
				{docsData.map((sec, i) => (
					...
					>
						...
						>
							{sec.items.length > 0 ? (
								<div className="disco:border-t disco:border-gray-200 disco:bg-white/60">
									{sec.items.map((item, j) => (
										...
										>
											<svg
												className="disco:w-5 disco:h-5 disco:text-gray-300 disco:shrink-0"
												fill="none"
												viewBox="0 0 24 24"
												stroke="currentColor"
											>
											...
											<div className="disco:flex-1">
												<p className="disco:text-base disco:text-primary disco:font-medium disco:m-0">
													{item.title?.rendered ||
														item.title}
												</p>
											</div>
								...
								<div className="disco:border-t disco:border-gray-200 disco:bg-white/60 disco:p-4 disco:text-center disco:text-sm disco:text-gray-400">
									No articles yet
								</div>
							)}
						</div>
