...
const CustomColorPicker = ({
	...
	return (
		...
		>
			...
			{isPickerOpen && (
				<div className="disco:fixed disco:top-0 disco:left-0 disco:w-full disco:h-full disco:bg-black/50 disco:flex disco:justify-center disco:items-center disco:z-100">
					<div
						ref={pickerRef}
