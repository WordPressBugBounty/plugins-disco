...
const FooterButtons = ({
	...
	return (
		<div className="disco:bg-white disco:flex disco:justify-between disco:items-center disco:shadow-[0_-3px_10px_5px_rgba(0,0,0,0.05)] disco:border-t disco:z-40 disco:border-gray-200 disco:py-2.5 disco:px-5 disco:gap-3 disco:mt-4 disco:sticky disco:bottom-0">
			{cancel ? (
				<Link to="/">
					<Button
