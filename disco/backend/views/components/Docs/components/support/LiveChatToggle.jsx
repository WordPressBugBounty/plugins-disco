...
export default function LiveChatToggle() {
	...
	return (
		<div className="disco:flex disco:items-center disco:gap-4 disco:p-4 disco:rounded-xl disco:border disco:border-gray-200 disco:bg-gray-50 disco:hover:bg-white disco:hover:shadow-sm disco:hover:border-primary disco:transition-all">
			<span className="disco:w-12 disco:h-12 disco:rounded-xl disco:flex disco:items-center disco:justify-center disco:shrink-0 disco:bg-[#ffd9d9]">
