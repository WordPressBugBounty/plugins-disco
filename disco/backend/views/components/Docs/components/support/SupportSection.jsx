...
export default function DiscoSupportSection() {
	...
	return (
		<div className="disco:w-full disco:py-4 disco:font-sans">
			<div className="disco:bg-white disco:rounded-2xl disco:border disco:border-gray-200 disco:shadow-sm disco:p-8 disco:flex disco:flex-col disco:md:flex-row disco:gap-8">
				<DiscoSupportHeader />
