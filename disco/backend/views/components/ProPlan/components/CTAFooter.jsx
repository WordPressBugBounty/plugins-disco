...
const CtaSection = () => {
	return (
		...
		>
			{/* Glow effect */}
			<div
				className="disco:absolute disco:-top-30 disco:-left-20 disco:w-87.5 disco:h-87.5 disco:rounded-full disco:pointer-events-none"
				style={{
					background:
			...
			<div className="disco:relative disco:z-10 disco:flex disco:flex-col disco:lg:flex-row disco:items-center disco:justify-between disco:gap-10 disco:px-10 disco:lg:px-16 disco:py-14">
				{/* Left content */}
				<div className="disco:flex-1">
					<p className="disco:text-xs! disco:font-bold disco:tracking-[2.5px] disco:uppercase disco:text-primary disco:mb-4 disco:flex disco:items-center disco:gap-1">
						<img
							src={imgRatingStar}
							alt="★"
					...
					<h2
						className="disco:text-4xl! disco:lg:text-[40px]! disco:font-extrabold disco:leading-tight! disco:text-white! disco:mb-4!"
					...
					<p className="disco:text-base! disco:text-white/50 disco:leading-relaxed! disco:max-w-115">
