...
const UnlockProBanner = () => {
	...
	return (
		<div className="disco:relative disco:overflow-hidden disco:rounded-[18px] disco:border disco:border-[rgba(34,197,94,0.15)] disco:flex disco:items-center disco:justify-between disco:gap-6 disco:px-10 disco:py-5 disco:bg-[linear-gradient(142deg,#0C1A10_0%,#1A3323_100%)]">
			...
			<div className="disco:absolute disco:right-7.25 disco:-top-7.5 disco:w-40 disco:h-40 disco:pointer-events-none disco:bg-[radial-gradient(circle_at_center,rgba(34,197,94,0.12)_0%,rgba(34,197,94,0)_65%)]" />
			...
			<div className="disco:flex disco:flex-col disco:gap-1 disco:min-w-0">
				...
				<p className="disco:m-0 disco:text-[12px] disco:leading-4.5 disco:text-white/80">
			...
			<a
				...
				className="disco:relative disco:shrink-0 disco:flex disco:items-center disco:justify-center disco:gap-1 disco:h-8.25 disco:min-w-44.75 disco:rounded-[14px] disco:text-white! disco:text-[12px] disco:font-extrabold disco:text-center disco:no-underline disco:px-5 disco:whitespace-nowrap disco:bg-[linear-gradient(135deg,#F59E0B_0%,#F97316_100%)] disco:shadow-[0px_3px_12px_0px_rgba(245,158,11,0.35)] disco:hover:text-white! disco:hover:scale-105 disco:transition-all! disco:duration-300 disco:focus:rounded-[14px]! disco:focus:outline-hidden! disco:focus:shadow-none! disco:focus:border-none!"
			>
