...
const DiscountView = () => {
	...
	return (
		<BadgeCardContainer className=" disco:h-100 disco:top-0 disco:sticky!">
			<div>
				<div className="disco:flex disco:items-start disco:gap-3 disco:bg-gray-50 disco:border disco:border-white disco:rounded-md disco:p-4">
					<div className="disco:flex disco:shrink-0 disco:bg-white disco:justify-center disco:items-center disco:rounded-md disco:p-2">
