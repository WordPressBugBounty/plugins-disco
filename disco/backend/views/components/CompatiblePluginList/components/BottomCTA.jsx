	...
	return (
		...
		>
			<div className="disco:flex disco:flex-col disco:gap-2 disco:max-w-[60%]">
				<h2 className="disco:text-white! disco:text-base! disco:font-extrabold! disco:tracking-[-0.2px] disco:leading-none">
					{__(
						'Unlock all integrations + 10× more power with Disco Pro',
						'disco'
					)}
				</h2>
				<p className="disco:text-gray-400! disco:text-[13px]! disco:font-normal disco:leading-[19.5px]">
					{__(
