export default function DiscoChannelCard({
	...
	return (
		<a
			...
			className="disco:flex disco:items-center disco:gap-4 disco:p-4 disco:rounded-xl disco:border disco:border-gray-200 disco:bg-gray-50 disco:hover:bg-white disco:hover:shadow-sm disco:transition-all disco:cursor-pointer disco:hover:border-primary disco:no-underline"
		>
			<span
				className={`disco:w-12 disco:h-12 disco:rounded-xl ${iconBg} disco:flex disco:items-center disco:justify-center disco:text-2xl disco:shrink-0`}
			>
				{icon}
			</span>
