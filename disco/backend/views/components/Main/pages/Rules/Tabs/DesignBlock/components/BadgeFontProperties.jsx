		...
		<div className={` ${className}`}>
			...
			<div className="disco:flex disco:justify-between disco:items-center disco:2xl:justify-start disco:bg-white disco:p-2 disco:gap-2 disco:rounded-lg disco:mt-1">
				...
				<SingleSelect
					...
					buttonClass="disco:rounded-lg! disco:pt-1! disco:pb-1! disco:font-thin! disco:text-sm! disco:min-w-[165px] disco:2xl:max-w-full"
					disabled={isValueEditable}
				/>
				<CustomNumberInput
					placeholder="Size"
				...
				<SingleSelect
					...
					buttonClass="disco:rounded-lg! disco:pt-1! disco:pb-1! disco:font-thin! disco:text-sm! disco:min-w-[130px]"
					disabled={isValueEditable}
				/>
				<SingleSelect
